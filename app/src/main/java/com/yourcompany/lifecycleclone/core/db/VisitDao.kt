...
interface VisitDao {
    ...
    fun observeVisitsInRange(from: Long, to: Long): Flow<List<VisitWithPlace>>
    ...
    @Query(
        "SELECT * FROM visits ORDER BY startTime DESC"
    )
    suspend fun getAllVisitsForDebug(): List<VisitEntity>
}
